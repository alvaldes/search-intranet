    ...
    <div className="flex overflow-x-hidden overflow-y-auto fixed h-full top-0 left-0 right-0 md:inset-0 z-50 justify-center items-center bg-gray-900/50">
      <div className="bg-white shadow-lg rounded-lg mx-auto max-w-md md:max-w-2xl min-w-min w-96">
        <div className="px-4 py-6">
  		...
  		C257.75,207.089,206.161,155.5,142.75,155.5z M59.075,255.5c7.106-39.739,41.923-70,83.675-70s76.569,30.261,83.675,70H59.075z"
            ...
            <p className="text-gray-700 mt-2">
              ...
              {user.cUJAEPersonDNI || user.identification}
            </p>
    	...
    	C60.096,45.161,60.447,42.832,59.427,40.907z"
                ...
                {user.telephoneNumber || user.phone}
              </div>
              <div>
                <svg
                  version="1.1"
		...
		L0.001,62.603L0,275.001c0.001,8.284,6.716,15,15,15L315.001,290c8.285,0,15-6.716,15-14.999V62.602l-30.001,22L173.871,177.097z"
            ...
            <div className="mt-3">
              <svg
                ...
                width="973.289px"
                height="973.29px"
                viewBox="0 0 973.289 973.29"
                className="inline w-3 h-5 mr-1"
              >
                <path
                  d="M973.289,932.657v-26.169c0-5.522-4.477-10-10-10h-28.496V174.633c0-5.523-4.479-10-10-10h-98.148
			...
			c-5.523,0-10-4.478-10-10v-86.956c0-5.522,4.477-10,10-10h52.098c5.523,0,10,4.478,10,10V372.791z"
              ...
              {user.area || `${user.distinguishedName.split(",")[1].slice(3)}`}
            </div>
            {user.teachingCategory ? (
            ...
            {user.cUJAEPersonType === "Student" && (
              <p className="text-gray-700 text-sm">
                ...
                {`Estudiante, ${user.cUJAEStudentYear}º Añó - Grupo ${user.cUJAEStudentGroup}`}
              </p>
            )}
